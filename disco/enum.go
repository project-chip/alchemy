...
func (b *Ball) organizeEnumSection(cxt *discoContext, dp *docParse, es *subSection) (err error) {
	...
	err = b.addMissingColumns(dp.doc, es.section, enumTable.element, enumTable.rows, matter.Tables[matter.TableTypeEnum].ColumnOrder, nil, enumTable.headerRow, enumTable.columnMap, types.EntityTypeEnumValue)
	if err != nil {
	...
	b.reorderColumns(dp.doc, es.section, &enumTable, matter.TableTypeEnum)
