...
func precleanStrings(doc *asciidoc.Document) {
	parse.Search(doc, asciidoc.RawReader, doc, doc.Children(), func(doc *asciidoc.Document, t *asciidoc.String, parent asciidoc.ParentElement, index int) parse.SearchShould {
