...
func precleanStrings(doc asciidoc.ParentElement) {
	parse.Search(asciidoc.NewRawIterator(), doc, doc.Children(), func(t *asciidoc.String, parent asciidoc.Parent, index int) parse.SearchShould {
...
func (b *Baller) postCleanUpStrings(doc *spec.Doc, root asciidoc.ParentElement) {
	parse.Search(doc.Iterator(), root, root.Children(), func(el any, parent asciidoc.Parent, index int) parse.SearchShould {
		switch el := el.(type) {
	...
	parse.Search(doc.Iterator(), root, root.Children(), func(t *asciidoc.String, parent asciidoc.Parent, index int) parse.SearchShould {
