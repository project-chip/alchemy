...
func (cmd *TestScript) Run(cc *Context) (err error) {
	...
	specification, specDocs, err = spec.Parse(cc, cmd.ParserOptions, cmd.ProcessingOptions, []spec.BuilderOption{spec.PatchForSdk(true)}, cmd.ASCIIDocAttributes.ToList())
