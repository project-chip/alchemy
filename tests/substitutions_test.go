...
var substitutionsTests = parseTests{
	...
	{"an externalized footnote macro may contain text formatting", "asciidoctor/substitutions_test_an_externalized_footnote_macro_may_contain_text_formatting.adoc", substitutionsTestAnExternalizedFootnoteMacroMayContainTextFormatting, nil},

	{"using a footnoteref macro should generate a warning when compat mode is not enabled", "asciidoctor/substitutions_test_using_a_footnoteref_macro_should_generate_a_warning_when_compat_mode_is_not_enabled.adoc", substitutionsTestUsingAFootnoterefMacroShouldGenerateAWarningWhenCompatModeIsNotEnabled, nil},

	{"should parse multiple footnote references in a single line", "asciidoctor/substitutions_test_should_parse_multiple_footnote_references_in_a_single_line.adoc", substitutionsTestShouldParseMultipleFootnoteReferencesInASingleLine, nil},

	{"should not resolve an inline footnote macro missing both id and text", "asciidoctor/substitutions_test_should_not_resolve_an_inline_footnote_macro_missing_both_id_and_text.adoc", substitutionsTestShouldNotResolveAnInlineFootnoteMacroMissingBothIdAndText, nil},
	...
	{"should be able to reference a bibliography entry in a footnote", "asciidoctor/substitutions_test_should_be_able_to_reference_a_bibliography_entry_in_a_footnote.adoc", substitutionsTestShouldBeAbleToReferenceABibliographyEntryInAFootnote, nil},

	{"footnotes in headings are expected to be numbered out of sequence", "asciidoctor/substitutions_test_footnotes_in_headings_are_expected_to_be_numbered_out_of_sequence.adoc", substitutionsTestFootnotesInHeadingsAreExpectedToBeNumberedOutOfSequence, nil},
	...
	{"registers multiple index term macros", "asciidoctor/substitutions_test_registers_multiple_index_term_macros.adoc", substitutionsTestRegistersMultipleIndexTermMacros, nil},

	{"visible shorthand index term macro should not consume leading round bracket", "asciidoctor/substitutions_test_visible_shorthand_index_term_macro_should_not_consume_leading_round_bracket.adoc", substitutionsTestVisibleShorthandIndexTermMacroShouldNotConsumeLeadingRoundBracket, nil},
	...
	{"should parse concealed shorthand index term with see and seealso", "asciidoctor/substitutions_test_should_parse_concealed_shorthand_index_term_with_see_and_seealso.adoc", substitutionsTestShouldParseConcealedShorthandIndexTermWithSeeAndSeealso, nil},

	{"should parse visible index term macro with see and seealso", "asciidoctor/substitutions_test_should_parse_visible_index_term_macro_with_see_and_seealso.adoc", substitutionsTestShouldParseVisibleIndexTermMacroWithSeeAndSeealso, nil},

	{"should parse concealed index term macro with see and seealso", "asciidoctor/substitutions_test_should_parse_concealed_index_term_macro_with_see_and_seealso.adoc", substitutionsTestShouldParseConcealedIndexTermMacroWithSeeAndSeealso, nil},

	{"replaces dashes", "asciidoctor/substitutions_test_replaces_dashes.adoc", substitutionsTestReplacesDashes, nil},
}
