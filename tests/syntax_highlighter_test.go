...
var syntaxHighlighterTests = parseTests{
	...
	{"should highlight source if source highlighter is set even if language is not set", "asciidoctor/syntax_highlighter_test_should_highlight_source_if_source_highlighter_is_set_even_if_language_is_not_set.adoc", syntaxHighlighterTestShouldHighlightSourceIfSourceHighlighterIsSetEvenIfLanguageIsNotSet},

	{"should not crash if source block has no lines and source highlighter is set", "asciidoctor/syntax_highlighter_test_should_not_crash_if_source_block_has_no_lines_and_source_highlighter_is_set.adoc", syntaxHighlighterTestShouldNotCrashIfSourceBlockHasNoLinesAndSourceHighlighterIsSet},

	{"should highlight source inside AsciiDoc table cell if source-highlighter attribute is set", "asciidoctor/syntax_highlighter_test_should_highlight_source_inside_ascii_doc_table_cell_if_source_highlighter_attribute_is_set.adoc", syntaxHighlighterTestShouldHighlightSourceInsideAsciiDocTableCellIfSourceHighlighterAttributeIsSet},
	...
	{"should highlight source if source-highlighter attribute is set", "asciidoctor/syntax_highlighter_test_should_highlight_source_if_source_highlighter_attribute_is_set.adoc", syntaxHighlighterTestShouldHighlightSourceIfSourceHighlighterAttributeIsSet},

	{"should not fail if source language is invalid", "asciidoctor/syntax_highlighter_test_should_not_fail_if_source_language_is_invalid.adoc", syntaxHighlighterTestShouldNotFailIfSourceLanguageIsInvalid},

	{"should number lines if third positional attribute is set", "asciidoctor/syntax_highlighter_test_should_number_lines_if_third_positional_attribute_is_set.adoc", syntaxHighlighterTestShouldNumberLinesIfThirdPositionalAttributeIsSet},

	{"should number lines if linenums option is set on source block", "asciidoctor/syntax_highlighter_test_should_number_lines_if_linenums_option_is_set_on_source_block.adoc", syntaxHighlighterTestShouldNumberLinesIfLinenumsOptionIsSetOnSourceBlock},
	...
	{"should preserve passthrough placeholders when highlighting source using coderay", "asciidoctor/syntax_highlighter_test_should_preserve_passthrough_placeholders_when_highlighting_source_using_coderay.adoc", syntaxHighlighterTestShouldPreservePassthroughPlaceholdersWhenHighlightingSourceUsingCoderay},
	...
	{"should read stylesheet", "asciidoctor/syntax_highlighter_test_should_read_stylesheet.adoc", syntaxHighlighterTestShouldReadStylesheet},
	...
	{"should load additional languages specified by highlightjs-languages", "asciidoctor/syntax_highlighter_test_should_load_additional_languages_specified_by_highlightjs_languages.adoc", syntaxHighlighterTestShouldLoadAdditionalLanguagesSpecifiedByHighlightjsLanguages},
	...
	{"should set lang attribute on pre when source-highlighter is html-pipeline", "asciidoctor/syntax_highlighter_test_should_set_lang_attribute_on_pre_when_source_highlighter_is_html_pipeline.adoc", syntaxHighlighterTestShouldSetLangAttributeOnPreWhenSourceHighlighterIsHtmlPipeline},

	{"should syntax highlight source if source-highlighter attribute is set", "asciidoctor/syntax_highlighter_test_should_syntax_highlight_source_if_source_highlighter_attribute_is_set.adoc", syntaxHighlighterTestShouldSyntaxHighlightSourceIfSourceHighlighterAttributeIsSet},

	{"should highlight source using a mixed lexer (HTML + JavaScript)", "asciidoctor/syntax_highlighter_test_should_highlight_source_using_a_mixed_lexer_(html_+_java_script).adoc", syntaxHighlighterTestShouldHighlightSourceUsingAMixedLexerHtmlJavaScript},

	{"should enable start_inline for PHP by default", "asciidoctor/syntax_highlighter_test_should_enable_start_inline_for_php_by_default.adoc", syntaxHighlighterTestShouldEnableStartInlineForPhpByDefault},
	...
	{"should not enable start_inline for PHP if mixed option is set", "asciidoctor/syntax_highlighter_test_should_not_enable_start_inline_for_php_if_mixed_option_is_set.adoc", syntaxHighlighterTestShouldNotEnableStartInlineForPhpIfMixedOptionIsSet},
	...
	{"should default to plain text lexer if lexer cannot be resolved for language", "asciidoctor/syntax_highlighter_test_should_default_to_plain_text_lexer_if_lexer_cannot_be_resolved_for_language.adoc", syntaxHighlighterTestShouldDefaultToPlainTextLexerIfLexerCannotBeResolvedForLanguage},
	...
	{"should gracefully fallback to default style if specified style not recognized", "asciidoctor/syntax_highlighter_test_should_gracefully_fallback_to_default_style_if_specified_style_not_recognized.adoc", syntaxHighlighterTestShouldGracefullyFallbackToDefaultStyleIfSpecifiedStyleNotRecognized},

	{"should restore isolated callout mark on last line of source", "asciidoctor/syntax_highlighter_test_should_restore_isolated_callout_mark_on_last_line_of_source.adoc", syntaxHighlighterTestShouldRestoreIsolatedCalloutMarkOnLastLineOfSource},
	...
	{"should preserve guard in front of callout if icons are not enabled", "asciidoctor/syntax_highlighter_test_should_preserve_guard_in_front_of_callout_if_icons_are_not_enabled.adoc", syntaxHighlighterTestShouldPreserveGuardInFrontOfCalloutIfIconsAreNotEnabled},

	{"should preserve guard around callout if icons are not enabled", "asciidoctor/syntax_highlighter_test_should_preserve_guard_around_callout_if_icons_are_not_enabled.adoc", syntaxHighlighterTestShouldPreserveGuardAroundCalloutIfIconsAreNotEnabled},

	{"should read stylesheet for specified style", "asciidoctor/syntax_highlighter_test_should_read_stylesheet_for_specified_style.adoc", syntaxHighlighterTestShouldReadStylesheetForSpecifiedStyle},

	{"should embed stylesheet for pygments style", "asciidoctor/syntax_highlighter_test_should_embed_stylesheet_for_pygments_style.adoc", syntaxHighlighterTestShouldEmbedStylesheetForPygmentsStyle},

	{"should restore callout marks to correct lines if table line numbering is enabled", "asciidoctor/syntax_highlighter_test_should_restore_callout_marks_to_correct_lines_if_table_line_numbering_is_enabled.adoc", syntaxHighlighterTestShouldRestoreCalloutMarksToCorrectLinesIfTableLineNumberingIsEnabled},
	...
	{"should line highlight specified lines", "asciidoctor/syntax_highlighter_test_should_line_highlight_specified_lines.adoc", syntaxHighlighterTestShouldLineHighlightSpecifiedLines},
}
