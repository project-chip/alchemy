...
var sectionsTests = parseTests{
	...
	{"should assign sectname, caption, and numeral to appendix section by default", "asciidoctor/sections_test_should_assign_sectname,_caption,_and_numeral_to_appendix_section_by_default.adoc", shouldAssignSectnameCaptionAndNumeralToAppendixSectionByDefault},
	...
	{"should use document attributes toc-class, toc-title and toclevels to create toc", "asciidoctor/sections_test_should_use_document_attributes_toc_class,_toc_title_and_toclevels_to_create_toc.adoc", shouldUseDocumentAttributesTocClassTocTitleAndToclevelsToCreateToc},
	...
	{"should use global attributes for toc-title, toc-class and toclevels for toc macro", "asciidoctor/sections_test_should_use_global_attributes_for_toc_title,_toc_class_and_toclevels_for_toc_macro.adoc", shouldUseGlobalAttributesForTocTitleTocClassAndToclevelsForTocMacro},
	
	{"should honor id, title, role and level attributes on toc macro", "asciidoctor/sections_test_should_honor_id,_title,_role_and_level_attributes_on_toc_macro.adoc", shouldHonorIdTitleRoleAndLevelAttributesOnTocMacro},
    ...
    &asciidoc.Section{
      AttributeList: asciidoc.AttributeList{
        &asciidoc.PositionalAttribute{
          ...
          Val: asciidoc.Set{
            &asciidoc.String{
              Value: "#idname.rolename%optionname",
            },
          },
        },
      },
    ...
    &asciidoc.Section{
      AttributeList: asciidoc.AttributeList{
        &asciidoc.PositionalAttribute{
          ...
          Val: asciidoc.Set{
            &asciidoc.String{
              Value: "discrete.independent#first",
            },
          },
        },
      },
