...
const (
	...
	SectionComposedDeviceTypeRequirements
...
var sectionTypeStrings = map[Section]string{
	...
	SectionComposedDeviceTypeRequirements: "ComposedDeviceTypeRequirements",
...
var sectionTypeNames = map[Section]string{
	...
	SectionComposedDeviceTypeRequirements: "Cluster Requirements on Composing Device Types",
