...
func (sp *IdlRenderer) registerIdlHelpers(t *raymond.Template, spec *spec.Specification) {
	...
	t.RegisterHelper("clusters", clustersHelper(spec, sp.provisionalFilter))
	t.RegisterHelper("enums", enumsHelper(sp.spec, sp.provisionalFilter))
	t.RegisterHelper("structs", clusterStructsHelper(sp.spec, sp.provisionalFilter))
	t.RegisterHelper("events", clusterEventsHelper(sp.spec, sp.provisionalFilter))
	t.RegisterHelper("commands", commandsHelper(sp.spec, sp.provisionalFilter))
	t.RegisterHelper("requests", requestsHelper(sp.spec, sp.provisionalFilter))
	...
	t.RegisterHelper("attributes", clusterAttributesHelper(sp.spec, sp.provisionalFilter, sp.commonAttributes))
	t.RegisterHelper("bitmaps", clusterBitmapsHelper(sp.spec, sp.provisionalFilter))
	t.RegisterHelper("bitmapBits", bitmapBitsHelper(sp.spec, sp.provisionalFilter))
	...
	t.RegisterHelper("ifHasValidFields", ifHasValidFieldsHelper(sp.spec, sp.provisionalFilter))
	...
	t.RegisterHelper("endpointServers", endpointServersHelper(sp.spec, sp.provisionalFilter))
	t.RegisterHelper("endpointClients", endpointClientsHelper(sp.spec, sp.provisionalFilter))
}
